  ...
  return (
    <div className="h-full w-full overflow-x-hidden overflow-y-scroll scroll-smooth pb-20">
      ...
      {albums.length === 0 && playlists.length === 0 && songs.length === 0 ? (
        <div className="flex min-h-[70dvh] w-full items-center justify-center bg-neutral-900">
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            <path
              ...
              fill="currentColor"
              className={`${isFavoritePlaying ? (isShuffling ? "fill-emerald-500" : "fill-white") : "fill-neutral-500"} ease duration-250 transition-colors`}
            />
          </g>
        </svg>
      </button>
