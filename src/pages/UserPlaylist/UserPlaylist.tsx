  ...
  return (
    <div className="flex h-auto w-full flex-col items-start justify-start sm:flex-row sm:items-center">
      ...
      <p
        ...
        className="mt-1 line-clamp-1 h-auto w-[80%] text-ellipsis text-left text-xl font-semibold text-white sm:line-clamp-3 sm:w-[40%] sm:text-3xl sm:font-bold"
      >
        {name}
      </p>
    </div>
...
const UserPlaylistControls = memo(({ id, songs, name }: UserPlaylist) => {
  ...
  return (
    <div
      data-testid="userplaylist-controls"
